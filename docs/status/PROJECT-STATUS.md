...
Last updated: 2026-07-09 — 🚇 티원 36cm 협소회랑 왕복순찰 완성: 근본원인 5연타 해체(재플랜 10Hz Pi포화→1Hz·진행률 20s·도착yaw 해제·ack 200ms·사전회전으로 회항 166→5s) + 왕복/복귀주차/방향정렬 풀시퀀스 3판 연속 성공(11/11, 454s) + 물리재배치 루프 `_dock_reseed.sh` 스킬화 + JSONL 주행기록 배포(다음 부팅부터). 어제 activate FAIL은 저전압 확정(만충 12.48V에서 8/8 OK). 티원 셧다운. **재개: ①티원 순찰 후 ~/patrol_runs.jsonl 레그판정 ②크롤 복불복(slowdown_ratio 0.35 후보) ③젠지 프리셋 P2**. 이전(07-08 밤): 🤝 젠지 4.1cm PASS + 맵-현실 98.5% + 프리셋 5종/드롭다운. 이전(07-08 저녁): 🧭 주행 개선 4종 처방 배포 — activate 검증 이월(→07-09 저전압 확정). 이전(07-08 오후): 🤖 티원 Unity좌표 주행 첫 성공 + 상주 4서비스.
